...
desired_cap = {'browser': 'Chrome', 'browser_version': '57.0', 'os': 'Windows', 'os_version': '7', 'resolution': '1024x768'}

driver = webdriver.Remote(
    command_executor='http://ali1302:KdR9xR4xyYNX7Avc1s7Q@hub.browserstack.com:80/wd/hub',
...
find_out_the_price = '.tag.invert.center.js--loadorder_top'
